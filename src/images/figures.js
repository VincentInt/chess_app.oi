...
const figurinesArray = {
  black: {
    pawn: { img: imgBlackPawn },
    rook: { img: imgBlackRook },
    knight: { img: imgBlackKnight },
    bishop: { img: imgBlackBishop },
    king: { img: imgBlackKing },
    queen: { img: imgBlackQueen },
  },
  white: {
    pawn: { img: imgWhitePawn },
    rook: { img: imgWhiteRook },
    knight: { img: imgWhiteKnight },
    bishop: { img: imgWhiteBishop },
    king: { img: imgWhiteKing },
    queen: { img: imgWhiteQueen },
  },
};
export default figurinesArray;
